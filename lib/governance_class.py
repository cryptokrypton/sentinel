...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to paccoind "gobject list" output
    ...
    def paccoind_serialise(self):
        import paccoinlib
        return paccoinlib.SHIM_serialise_for_paccoind(self.serialise())
